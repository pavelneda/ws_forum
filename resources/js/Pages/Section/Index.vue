            ...
            <div class="flex items-center">
                ...
                <template v-if="this.$page.props.auth.roles.some(role => {
                    ...
                    <Link :href="route('sections.create')">
                        <SecondaryButton class="mr-2 !p-1 !px-2">+Section</SecondaryButton>
                    </Link>
                </template>
                <Link :href="route('branches.create')">
                    <SecondaryButton class="!p-1 !px-2">+Branch</SecondaryButton>
                </Link>
            </div>
        </template>
            ...
            <div v-if="sections" class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                <template v-for="section in sections">
                    <div v-if="section.branches.length">
                        <div class="flex items-center section__title rounded-t-3xl px-6 py-2 text-lg text-white">
